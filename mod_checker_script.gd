...
# 
var min_version_major : int = INF # Setting this to INF will mean no min version is checked
...
var dialogue_box_title : String = "ModMenu redundancy notice!"
...
var custom_message_string : String = "Mod Menu is now depreciated. Please use Mod Menu 2 \n\nThis mod will continue to stay available, for any features that won't be ported to Mod Menu 2 or no standalone mod was made for.\n\nPress OK to open the download page"
...
var download_URL : String = "https://github.com/rwqfsfasxc100/ModMenu2/releases/latest"
